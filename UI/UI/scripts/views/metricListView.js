   ...
   'jquery-sortable'
    ...
    var MetricListView = BaseCompositeView.extend({
        ...
        calculateMap: function (e) {
            ...
            for (var i = 0; i < this.sibling.dimensionArray.length; i++) {
        ...
        render: function () {
            ...
            var metricsCopy = this.allMetrics.toJSON().slice(0);
            var arr = self.lastIntersection;
            console.log(arr);
            metricsCopy.forEach(function (e) {
                console.log("e", e);
                if (arr) {
                    if ($.inArray(e.MetricId, arr)) {
...
//            console.log(metricsCopy);
            this.grouped = _.groupBy(metricsCopy, function (metric) {
