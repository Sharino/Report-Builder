    ...
    public class KpiToPdfHandler
    {
        ...
        public string HandleCore(ExportRequest request)
        {
            try
            {
                ...
                page.Paragraphs.Add(new TextFragment("Generation " + request.GeneratedDate) { HorizontalAlignment = HorizontalAlignment.Left });
                ...
                page.Paragraphs.Add(new TextFragment("Period:") { HorizontalAlignment = HorizontalAlignment.Left });
